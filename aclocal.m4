...
m4_include([config/kernel-bio-empty-barrier.m4])
...
m4_include([config/kernel-req-sync.m4])
...
m4_include([config/user-libshare.m4])
m4_include([config/user-libuuid.m4])
m4_include([config/user-nptl_guard_within_stack.m4])
